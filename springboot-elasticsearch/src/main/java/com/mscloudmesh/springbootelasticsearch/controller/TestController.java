package com.mscloudmesh.springbootelasticsearch.controller;


import com.mscloudmesh.springbootelasticsearch.elasticsearch.ElasticsearchUtil;
import com.mscloudmesh.springbootelasticsearch.elasticsearch.EsPage;
import com.mscloudmesh.springbootelasticsearch.model.Book;
import com.mscloudmesh.springbootelasticsearch.model.EsModel;
...
public class TestController {
    ...
    public String queryPage(String startPage, String pageSize ,String context) {
        if (StringUtils.isNotBlank(startPage) && StringUtils.isNotBlank(pageSize)) {
            ...
            BoolQueryBuilder boolQuery = QueryBuilders.boolQuery();
            boolQuery.must(QueryBuilders.rangeQuery("creatDate").from("2018-12-20T02:03:08.829Z").to("2019-12-21T02:03:09.727Z").includeLower(true).includeUpper(true))
...
//            boolQuery.filter(QueryBuilders.matchQuery("name",context));
     ...
     */
    @GetMapping("/min")
    public double minAgg(){
       return ElasticsearchUtil.minAgg(indexName,esType,"price");
    }
     ...
     */
    @GetMapping("/max")
    public double maxAgg(){
        return ElasticsearchUtil.maxAgg(indexName,esType,"price");
    }
     ...
     */
    @GetMapping("/sum")
    public double sumAgg(){

        return ElasticsearchUtil.sumAgg(indexName,esType,"price");
    }
     ...
     */
    @GetMapping("/avg")
    public double avgAgg(){

        return ElasticsearchUtil.avgAgg(indexName,esType,"price");
    }
    ...
    @GetMapping("/base")
    public Stats base(){
        return ElasticsearchUtil.stats(indexName,esType,"price");
    }
    ...
    public ExtendedStats extendedStats(){
        return ElasticsearchUtil.extendedStats(indexName,esType,"price");
    }
    ...
    public Double  cardinality (){
        return ElasticsearchUtil.cardinality(indexName,esType,"price");
    }
    /**
     * 百分比
    ...
    public Percentiles percentiles (){
        return ElasticsearchUtil.percentiles(indexName,esType,"price");
    }
    ...
    public Double valueCount (){
        return ElasticsearchUtil.valueCount(indexName,esType,"price");
    }
    ...
    public void groupByName (){
          ElasticsearchUtil.groupSearch(indexName,esType,"price");
    }
     ...
     */
    @GetMapping("/multiGroup")
    public void multiGroup (){
        ElasticsearchUtil.multiGroup(indexName,esType,"price");
    }
}
